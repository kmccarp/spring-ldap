 ...
 * expected of an attribute parser. Attributes are validated to ensure they conform to the
 * requirements for attribute values prescribed in RFC2849.
 *
 * @author Keith Barlow
 *
 */
...
public class DefaultAttributeValidationPolicyTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				{ "title;lang-en;phonetic: Sales, Director", "title", ";lang-en;phonetic", "Sales, Director",
				...
				{ "xml:: PD94bWwgdmVyc2lvbj0iMS4wIiBlbmNvZGluZz0iVVRGLTgiPz4=", "xml", "",
						"PD94bWwgdmVyc2lvbj0iMS4wIiBlbmNvZGluZz0iVVRGLTgiPz4=", AttributeType.BASE64 },
				{ "ou;lang-ja;phonetic:: 44GI44GE44GO44KH44GG44G2", "ou", ";lang-ja;phonetic",
						"44GI44GE44GO44KH44GG44G2", AttributeType.BASE64 },
				{ "dn:: dWlkPXJvZ2FzYXdhcmEsb3U95Za25qWt6YOoLG89QWlyaXVz", "dn", "",
						"dWlkPXJvZ2FzYXdhcmEsb3U95Za25qWt6YOoLG89QWlyaXVz", AttributeType.BASE64 },
				{ "cn;lang-ja:: 5bCP56yg5Y6fIOODreODieODi+ODvA==", "cn", ";lang-ja", "5bCP56yg5Y6fIOODreODieODi+ODvA==",
						AttributeType.BASE64 },
				{ "cn;lang-ja:: 5bCP56yg5Y6fIO.ODreODieODi+ODvA==", "cn", ";lang-ja",
						"5bCP56yg5Y6fIO.ODreODieODi+ODvA==", AttributeType.BASE64 },

				// Url
				{ "url:< https://www.oracle.com/", "url", "", "https://www.oracle.com/", AttributeType.URL },
				{ "url:< https://java.sun.com/j2se/1.3/docs/guide/collections/designfaq.html", "url", "",
						"https://java.sun.com/j2se/1.3/docs/guide/collections/designfaq.html", AttributeType.URL },
				{ "url:< ftp://kbarlow:test@ftp.is.co.za/rfc/rfc1808.txt", "url", "",
						"ftp://kbarlow:test@ftp.is.co.za/rfc/rfc1808.txt", AttributeType.URL },
				{ "url;option:< ftp://ftp.is.co.za:2100/rfc/rfc1808.txt;type=a", "url", ";option",
						"ftp://ftp.is.co.za:2100/rfc/rfc1808.txt;type=a", AttributeType.URL },
				{ "url:< telnet://kbarlow@melvyl.ucop.edu/", "url", "", "telnet://kbarlow@melvyl.ucop.edu/",
						AttributeType.URL },
				{ "url;option1;option2:< telnet://kbarlow:test@melvyl.ucop.edu/", "url", ";option1;option2",
						"telnet://kbarlow:test@melvyl.ucop.edu/", AttributeType.URL },
				{ "url:< gopher://spinaltap.micro.umn.edu/00/Weather/California/Los%20Angeles", "url", "",
						"gopher://spinaltap.micro.umn.edu/00/Weather/California/Los%20Angeles", AttributeType.URL },
				{ "url:< file:///usr/local/directory/photos/fiona.jpg", "url", "",
						"file:///usr/local/directory/photos/fiona.jpg", AttributeType.URL },
				{ "url:< mailto:java-net@java.sun.com", "url", "", "mailto:java-net@java.sun.com", AttributeType.URL },
				{ "url:< news:comp.infosystems.www.servers.unix", "url", "", "news:comp.infosystems.www.servers.unix",
						AttributeType.URL },
				{ "url:< prospero://host.dom:1525//pros/name;key=value", "url", "",
						"prospero://host.dom:1525//pros/name;key=value", AttributeType.URL },
				{ "url:< nntp://news.cs.hut.fi/alt.html/239157", "url", "", "nntp://news.cs.hut.fi/alt.html/239157",
						AttributeType.URL },
				{ "url:< wais://vega.lib.ncsu.edu/alawon.src?nren", "url", "",
						"wais://vega.lib.ncsu.edu/alawon.src?nren", AttributeType.URL },
				{ "url:< https://java.sun.com/j2se/1.3/docs/guide/collections/designfaq.html#28", "url", "",
						"https://java.sun.com/j2se/1.3/docs/guide/collections/designfaq.html#28", AttributeType.URL },
	 ...
	 */
	public DefaultAttributeValidationPolicyTest(String line, String id, String options, String value,
			AttributeType type) {
		this.line = line;
		this.id = id;
