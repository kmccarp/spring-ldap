...
public class ContextSourceTransactionManagerNamespaceIntegrationTests extends AbstractLdapTemplateIntegrationTests {

	private static Logger log = LoggerFactory.getLogger(ContextSourceTransactionManagerNamespaceIntegrationTests.class);
